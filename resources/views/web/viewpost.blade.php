...
@section('content')
   ...
   margin-top: 2px; 
        ...
        <section class="single-post spad">
                ...
                {{-- <div class="single-post__hero set-bg" data-setbg="{{ asset($posts->image) }}">
                </div> --}}
                    ...
                    <div class="col-lg-8">
                        <div class="single-post__title">
                            <div class="single-post__title__meta">
                                ...
                                <h2> {{ date('d', strtotime($posts->created_at)) }}</h2>
                            <span>{{ date('M', strtotime($posts->created_at)) }}</span>
                            {{-- <span>{{ date('Y', strtotime($posts->created_at)) }}</span> --}}
                            </div>  
                            <div class="single-post__title__text">
                                ...
                                <ul class="widget">
                                    <li>by Admin</li>
                                    <li>{{ktCategoryName($posts->category_id)}}</li>
                                </ul>
                            </div>
                        </div>
